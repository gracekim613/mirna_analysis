...
percentages_7m8 = [b_cell[m]['percentages']['7m8'] for m in mirnas]
percentages_7a1 = [b_cell[m]['percentages']['7a1'] for m in mirnas]
...
plt.tight_layout()
plt.savefig('mirna_data/b_cell_binding_pattern_stacked.png', dpi=300)
plt.show()

print("✓ 저장: mirna_data/b_cell_binding_pattern_stacked.png")
