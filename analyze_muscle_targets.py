...
def main():
    print("=" * 60)
    print("Muscle Cell miRNA Binding Pattern 분석")
    print("=" * 60)
    ...
    # 분석
    print(f"\n분석 중: {len(MUSCLE_CELL_MIRNAS)}개 miRNA")
    print("-" * 60)
    results = analyze_binding_patterns(df, MUSCLE_CELL_MIRNAS)
    
    # 결과 저장
    output_file = 'mirna_data/muscle_cell_binding_patterns.json'
