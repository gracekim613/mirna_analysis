...
def main():
    print("=" * 60)
    print("B Cell miRNA Binding Pattern 분석")
    print("=" * 60)
    ...
    # 분석
    print(f"\n분석 중: {len(B_CELL_MIRNAS)}개 miRNA")
    print("-" * 60)
    results = analyze_binding_patterns(df, B_CELL_MIRNAS)
    
    # 결과 저장
    output_file = 'mirna_data/b_cell_binding_patterns.json'
